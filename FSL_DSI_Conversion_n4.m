% Code will convert FSL BEDPOSTX data into DSISTUDIO .fib file; file is for n=4 fibers; 
...
theta4 = load_untouch_nii('/Volumes/TrinityDrive/N51200/bedpost/bedpost_fullbrain_ESR12/mean_th4samples.nii.gz');
...
phi4 = load_untouch_nii('/Volumes/TrinityDrive/N51200/bedpost/bedpost_fullbrain_ESR12/mean_ph4samples.nii.gz');
...
f4 = load_untouch_nii('/Volumes/TrinityDrive/N51200/bedpost/bedpost_fullbrain_ESR12/mean_f4samples.nii.gz');
...
fib.fa3 = double(reshape(f4.img,1,[]));
...
fib.dir3(1,:,:,:) = sin(theta4.img).*cos(phi4.img);
fib.dir3(2,:,:,:) = sin(theta4.img).*sin(phi4.img);
fib.dir3(3,:,:,:) = cos(theta4.img);
fib.dir0 = double(reshape(fib.dir0,3,[]));
fib.dir1 = double(reshape(fib.dir1,3,[]));
fib.dir2 = double(reshape(fib.dir2,3,[]));
fib.dir3 = double(reshape(fib.dir3,3,[]));
...
fib.fa3 = reshape(fib.fa3,fib.dimension);
fib.fa3 = fib.fa3(fib.dimension(1):-1:1,fib.dimension(2):-1:1,:);
...
fib.dir3 = reshape(fib.dir3,[3 fib.dimension]);
fib.dir3 = fib.dir2(:,fib.dimension(1):-1:1,fib.dimension(2):-1:1,:);
fib.dir3(3,:,:,:) = -fib.dir3(3,:,:,:);
